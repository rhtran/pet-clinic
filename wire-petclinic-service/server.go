...
import (
	...
	"wire-petclinic-service/internal/api/health"
	"wire-petclinic-service/internal/api/info"
	"wire-petclinic-service/internal/api/owner"
	"wire-petclinic-service/internal/api/pet"
	"wire-petclinic-service/internal/api/vet"
	"wire-petclinic-service/internal/api/visit"
	"wire-petclinic-service/middleware"
	"wire-petclinic-service/pkg/dbase"
	"wire-petclinic-service/pkg/ds"

...
// Repository searches pet from the database
type Repository struct {
	logger log.Logger
	pg     *gorm.DB
}

func NewPetRepository(logger log.Logger, pg *gorm.DB) *Repository {
	return &Repository{
		logger: logger,
		pg:     pg,
	}
...
*/
func (repository *Repository) FindById(id int) (*Pet, error) {
...
*/
func (repository *Repository) FindByName(name string) ([]Pet, error) {
...
func (repository *Repository) Insert(pet *Pet) (*Pet, error) {
...
func (repository *Repository) Update(pet *Pet) (*Pet, error) {

...
func (_m *MockServicer) create(owner *repository.Owner) (*Response, error) {
	ret := _m.Called(owner)
	...
	var r0 *Response
	var r1 error
	if rf, ok := ret.Get(0).(func(*repository.Owner) (*Response, error)); ok {
		return rf(owner)
	}
	if rf, ok := ret.Get(0).(func(*repository.Owner) *Response); ok {
		r0 = rf(owner)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockServicer_create_Call) Run(run func(owner *repository.Owner)) *MockServicer_create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*repository.Owner))
	})
	return _c
}
...
func (_c *MockServicer_create_Call) RunAndReturn(run func(*repository.Owner) (*Response, error)) *MockServicer_create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockServicer) update(owner *repository.Owner) (*Response, error) {
	ret := _m.Called(owner)
...
func (_c *MockServicer_update_Call) Run(run func(owner *repository.Owner)) *MockServicer_update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*repository.Owner))
	})
	return _c
...
func (_c *MockServicer_update_Call) RunAndReturn(run func(*repository.Owner) (*Response, error)) *MockServicer_update_Call {
	_c.Call.Return(run)
	return _c
}

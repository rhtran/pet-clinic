...
func (_m *MockServicer) create(owner *owner.Owner) (*Response, error) {
	ret := _m.Called(owner)
	...
	var r0 *Response
	var r1 error
	if rf, ok := ret.Get(0).(func(*owner.Owner) (*Response, error)); ok {
		return rf(owner)
	}
	if rf, ok := ret.Get(0).(func(*owner.Owner) *Response); ok {
		r0 = rf(owner)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*owner.Owner) error); ok {
		r1 = rf(owner)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockServicer_create_Call) Run(run func(owner *owner.Owner)) *MockServicer_create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*owner.Owner))
	})
	return _c
}
...
func (_c *MockServicer_create_Call) RunAndReturn(run func(*owner.Owner) (*Response, error)) *MockServicer_create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockServicer) update(owner *owner.Owner) (*Response, error) {
	ret := _m.Called(owner)
...
func (_c *MockServicer_update_Call) Run(run func(owner *owner.Owner)) *MockServicer_update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*owner.Owner))
	})
	return _c
...
func (_c *MockServicer_update_Call) RunAndReturn(run func(*owner.Owner) (*Response, error)) *MockServicer_update_Call {
	_c.Call.Return(run)
	return _c
}

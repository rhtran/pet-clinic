...
func (_m *MockVetServicer) Create(vet *vet.Vet) (*Response, error) {
	ret := _m.Called(vet)
	...
	var r0 *Response
	var r1 error
	if rf, ok := ret.Get(0).(func(*vet.Vet) (*Response, error)); ok {
		return rf(vet)
	}
	if rf, ok := ret.Get(0).(func(*vet.Vet) *Response); ok {
		r0 = rf(vet)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*vet.Vet) error); ok {
		r1 = rf(vet)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockVetServicer_Create_Call) Run(run func(vet *vet.Vet)) *MockVetServicer_Create_Call {
...
func (_c *MockVetServicer_Create_Call) RunAndReturn(run func(*vet.Vet) (*Response, error)) *MockVetServicer_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockVetServicer) Update(vet *vet.Vet) (*Response, error) {
	ret := _m.Called(vet)
...
func (_c *MockVetServicer_Update_Call) Run(run func(vet *vet.Vet)) *MockVetServicer_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*vet.Vet))
	})
	return _c
...
func (_c *MockVetServicer_Update_Call) RunAndReturn(run func(*vet.Vet) (*Response, error)) *MockVetServicer_Update_Call {
	_c.Call.Return(run)
	return _c
}
